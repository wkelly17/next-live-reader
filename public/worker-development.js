...
self.addToCacheAsync = async function addToCacheAsync(cacheName, request, checkForExistingResponse = false) {
...
self.getReqWithoutQueryString = function getReqWithoutQueryString(url) {
